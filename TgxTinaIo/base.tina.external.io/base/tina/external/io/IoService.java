...
public class IoService
{
	...
	public IoTask<?> requestService(ITaskFactory<String, IoSession<?>, IoFilter, IoTask<?>> taskFactory, String url, int mode, IoFilter filter, Object toWrite, boolean isShedule, int timelimit, long delayTime, byte retryLimit, Object attachment, ITaskProgress progress, int timeOutSecound, ITaskTimeout<?> taskTimeOut, int bindSerial) {
	...
	public IoTask<?> requestService(ITaskFactory<String, IoSession<?>, IoFilter, IoTask<?>> taskFactory, IoSession<?> ioSession, IoFilter filter, Object toWrite, boolean isShedule, int timeLimit, long delayTime, byte retryLimit, Object attachment, ITaskProgress progress, int timeOutSecound, ITaskTimeout<?> taskTimeOut, int bindSerial) {
		if (taskFactory == null) taskFactory = defaultFactory;
		if (taskFactory == null) return null;
	...
	public IoTask<?> requestService(ITaskFactory<String, IoSession<?>, IoFilter, IoTask<?>> taskFactory, String url, int mode, IoFilter filter, Object ioBuffer, boolean schedule, int timeOutSecound, ITaskTimeout<?> taskTimeOut) {
	...
	public IoTask<?> requestService(ITaskFactory<String, IoSession<?>, IoFilter, IoTask<?>> taskFactory, String url, int mode, IoFilter filter, Object ioBuffer, boolean schedule, int timeOutSecound, ITaskTimeout<?> taskTimeOut, int bindSerial) {
	...
	public IoTask<?> requestService(ITaskFactory<String, IoSession<?>, IoFilter, IoTask<?>> taskFactory, IoSession<?> ioSession, IoFilter filter, Object ioBuffer, boolean schedule, int timeOutSecound, ITaskTimeout<?> taskTimeOut) {
	...
	public IoTask<?> requestService(ITaskFactory<String, IoSession<?>, IoFilter, IoTask<?>> taskFactory, IoSession<?> ioSession, IoFilter filter, Object ioBuffer, boolean schedule, int timeOutSecound, ITaskTimeout<?> taskTimeOut, int bindSerial) {
