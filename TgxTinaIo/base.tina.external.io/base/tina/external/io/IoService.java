...
public class IoService
{
	...
	public IoTask<?> requestService(IoSession<?> ioSession, IoFilter filter, Object ioBuffer, int bindSerial) {
		return requestService(null, ioSession, filter, ioBuffer, false, -1, -1, (byte) 0, null, null, 0, null, bindSerial);
	}
	...
	public IoTask<?> requestService(IoSession<?> ioSession, IoFilter filter, Object ioBuffer, boolean schedule, int timeOutSecound, ITaskTimeout<?> taskTimeOut, int bindSerial) {
		return requestService(null, ioSession, filter, ioBuffer, schedule, -1, -1, (byte) 0, null, null, timeOutSecound, taskTimeOut, bindSerial);
	}
