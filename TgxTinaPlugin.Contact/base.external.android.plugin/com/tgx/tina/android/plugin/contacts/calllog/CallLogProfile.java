        ...
        Profile
{
	...
	public CallEntry addEntry(long duration, long date, int type, int _id) {
		CallEntry entry = new CallEntry(duration, date, type, _id);
		entries.add(entry);
		return entry;
	}
	...
	public static class CallEntry
	{
		...
		public CallEntry(long duration, long date, int type, int _id) {
	...
	public Profile clone() {
		...
		for (CallEntry callEntry : entries)
			callLogProfile.addEntry(callEntry.duration, callEntry.date, callEntry.type, callEntry._id);
